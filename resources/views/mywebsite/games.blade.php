...
@section('title', 'Page Title Games')
	...
	<div class="container">
		...
		<div class="main">
                <div class="view view-first">
                    {!! HTML::image('resource/images/1.jpg', 'a picture') !!}
                    <div class="mask">
                        <h2>Game Never</h2>
                ...
                <div class="view view-first">
                    {!! HTML::image('resource/images/2.jpg', 'a picture') !!}
                    <div class="mask">
                        <h2>Online Game</h2>
                        <p>A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart.</p>
                        <a href="single.html" class="info">Play It</a>
                ...
                <div class="view view-first">
                    {!! HTML::image('resource/images/3.jpg', 'a picture') !!}
                    <div class="mask">
                        <h2>Delmen lorem</h2>
                        <p>A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart.</p>
                        <a href="single.html" class="info">Play It</a>
                ...
                <div class="view view-first">
                    {!! HTML::image('resource/images/4.jpg', 'a picture') !!}
                    <div class="mask">
                        <h2>Ipsum street</h2>
                        <p>A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart.</p>
                        <a href="single.html" class="info">Play It</a>
                ...
                <div class="view view-first">
                    {!! HTML::image('resource/images/5.jpg', 'a picture') !!}
                    <div class="mask">
                        <h2>Games online</h2>
                        <p>A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart.</p>
                        <a href="single.html" class="info">Play It</a>
                ...
                <div class="view view-first">
                    {!! HTML::image('resource/images/6.jpg', 'a picture') !!}
                    <div class="mask">
                ...
                <div class="view view-first">
    				{!! HTML::image('resource/images/7.jpg', 'a picture') !!}
                    <div class="mask">
                        <h2>Ipsum street</h2>
                        <p>A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart.</p>
                        <a href="single.html" class="info">Play It</a>
                ...
                <div class="view view-first">
                    {!! HTML::image('resource/images/8.jpg', 'a picture') !!}
                    <div class="mask">
                        <h2>Games online</h2>
                        <p>A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart.</p>
                        <a href="single.html" class="info">Play It</a>
                ...
                <div class="view view-first">
                  	{!! HTML::image('resource/images/9.jpg', 'a picture') !!}
                    <div class="mask">
                        <h2>Nothing but Game</h2>
                        <p>A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart.</p>
                        <a href="single.html" class="info">Play It</a>
